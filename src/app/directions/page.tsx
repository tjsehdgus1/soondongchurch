                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-800 font-medium">전라남도 순천시 순동</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-800 font-medium">전화번호를 입력해 주세요</p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-blue-50 rounded-2xl border border-blue-100 p-6">
                            <h2 className="text-base font-bold text-blue-900 mb-3">대중교통 안내</h2>
                            <p className="text-blue-700 text-sm leading-relaxed">대중교통 안내 내용을 입력해 주세요.</p>
                        </div>
                    </div>
                </div>
            </div>
