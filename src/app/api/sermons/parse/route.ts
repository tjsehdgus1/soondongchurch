...
export async function POST(req: Request) {
    try {
        ...
        const TAG_POOL = [
            // 성경 본문
            '창세기','출애굽기','시편','잠언','이사야','예레미야','에스겔','다니엘',
            '마태복음','마가복음','누가복음','요한복음','사도행전',
            '로마서','고린도전서','고린도후서','갈라디아서','에베소서','빌립보서',
            '골로새서','데살로니가전서','디모데전서','히브리서','야고보서','베드로전서','요한계시록',
            // 절기
            '대림절','성탄절','사순절','고난주간','부활절','성령강림절','추수감사절',
            // 신앙 주제
            '구원','은혜','믿음','소망','사랑','기도','회개','용서','감사','십자가',
            '성령','말씀','예배','제자도','선교','봉사','공동체','가정','치유','천국',
        ]
...

{
  ...
  "tags": [] // 아래 태그 풀에서만 2~4개 선택, 목록에 없는 태그는 절대 추가 금지
}
