        ...
        <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <article className="bg-white rounded-2xl shadow-sm border overflow-hidden" style={{ borderColor: '#E8E4DE' }}>
                ...
                <div className="px-8 py-7 border-b" style={{ borderColor: '#E8E4DE' }}>
                    ...
                    <div className="flex items-center gap-4 mt-4 text-sm" style={{ color: '#8B7355' }}>
                        <span className="flex items-center gap-1.5">
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: '#C8C2B8' }}>
                        ...
                        {notice.updated_at !== notice.created_at && (
                            <span className="text-xs" style={{ color: '#C8C2B8' }}>
                ...
                <div className="px-8 py-8">
                    <div className="prose prose-gray max-w-none leading-loose whitespace-pre-wrap" style={{ color: '#2D2A26' }}>
                        {notice.content}
                    </div>
                </div>
            </article>
            ...
            <div className="mt-8 flex justify-between">
                <Link href="/notices"
                    className="flex items-center gap-2 px-5 py-2.5 text-sm font-medium bg-white border rounded-xl transition-colors"
